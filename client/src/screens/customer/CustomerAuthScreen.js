...
const CustomerAuthScreen = ({ navigation }) => {
  ...
  const handleGoogleAuth = async () => {
    try {
      ...
      if (Platform.OS === 'web') {
        localStorage.setItem('oauth_selected_role', 'customer');
      } else {
        await SecureStore.setItemAsync('oauth_selected_role', 'customer');
      }
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.subtitle}>
            {isSignUpMode ? 'Register to book professionals' : 'Log in to manage your bookings'}
          </Text>
            ...
            >
              {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                <View style={styles.formContainer}>
                  ...
                  <View style={styles.toggleContainer}>
                    <Text style={styles.toggleText}>New Customer? </Text>
